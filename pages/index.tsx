    ...
    <>
      ...
      <div className="relative ">
        <video
          ...
          poster="/Screenshot (56).jpg"
        ></video>

        <div
          className="main-div h-[100vh] w-full overflow-hidden bg-cover mob:hidden"
          // style={{ backgroundImage: 'url("/Screenshot (55).png")' }}
        >
          <div className="px-[100px] pt-[35px] relative">
            <div className="nav-main-div flex flex-row items-center justify-between rounded-[37px] bg-primary px-[50px] py-[10px] ">
              <Link href="/">
                <h2 className="cursor-pointer font-bold text-accent">
                  GROUNDS
                </h2>
              </Link>
              ...
              <div className="flex flex-row gap-9">
                ...
                <Link href="/">
                  <p className=" font-medium leading-6 text-accent">
                    Programmes
                  </p>
                </Link>
                <Link href="/">
          ...
          <div className="footer-para-main-div px-[100px] pt-[22px] relative">
